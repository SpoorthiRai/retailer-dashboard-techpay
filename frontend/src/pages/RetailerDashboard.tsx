        ...
        {activeTab === 'inventory' && (
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-0.5">
                Stock levels across your stores
              </p>
            </div>
                      ...
                      return (
                        <tr key={store.storeId}
                          ...
                          <td className="py-3 pr-4">
                            {store.name}
                            {isYours && (
                              <span className="ml-2 text-[10px] bg-blue-100
                                               text-blue-600 px-1.5 py-0.5 rounded-full">
                                ← You
                              </span>
                            )}
                          </td>
                          ...
                          <td className="py-3 pr-4">
                            <span className={`font-semibold
                              ${store.failRate >= 70 ? 'text-red-500' :
                                store.failRate >= 40 ? 'text-amber-500' :
                                'text-green-600'}`}>
                              {store.failRate}%
                            </span>
                          </td>
